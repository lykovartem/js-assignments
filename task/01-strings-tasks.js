...
function getRectangleString(width, height) {
    var horizontalLine = '─',
        ...
        leftBottomAngle = '└',
        rightBottomAngle = '┘';
    var topLine = leftTopAngle + horizontalLine.repeat(width - 2) + rightTopAngle + '\n';
    var bottomLine = leftBottomAngle + horizontalLine.repeat(width - 2) + rightBottomAngle + '\n';
    var line = verticalLine + ' '.repeat(width - 2) + verticalLine + '\n';
    var body = line.repeat(height - 2);
...
function encodeToRot13(str) {
    ...
    for (var i = 0; i < str.length; i++) {
        ...
        if ((letter >= 65 && letter <= 77) ||
            (letter >= 97 && letter <= 109)) {
            var str2 = String.fromCharCode(letter + 13);
            arr.push(str2);
        }
        else if ((letter >= 78 && letter <= 90) ||
            (letter >= 110 && letter <= 122)) {
            var str2 = String.fromCharCode(letter - 13);
            arr.push(str2);
        }
        else {
